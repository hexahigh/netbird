...
type Body struct {
	...
	// multipathPaths are the extra underlay WireGuard paths the sender
	// advertises for this peer, in addition to the main connection. Only
	// present when both peers advertise the multipath feature.
	MultipathPaths []*PathEndpoint `protobuf:"bytes,12,rep,name=multipathPaths,proto3" json:"multipathPaths,omitempty"`
}
...
func (x *Body) GetMultipathPaths() []*PathEndpoint {
	if x != nil {
		return x.MultipathPaths
	}
	return nil
}

// PathEndpoint describes one extra underlay WireGuard path.
type PathEndpoint struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// ip is the underlay address, encoded as 4 bytes (IPv4) or 16 bytes (IPv6).
	Ip []byte `protobuf:"bytes,1,opt,name=ip,proto3" json:"ip,omitempty"`
	// port is the WireGuard listen port of the path interface.
	Port uint32 `protobuf:"varint,2,opt,name=port,proto3" json:"port,omitempty"`
	// probePort is the UDP echo port used for path liveness checks.
	ProbePort uint32 `protobuf:"varint,3,opt,name=probePort,proto3" json:"probePort,omitempty"`
}

func (x *PathEndpoint) Reset() {
	*x = PathEndpoint{}
	if protoimpl.UnsafeEnabled {
...
func (x *PathEndpoint) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PathEndpoint) ProtoMessage() {}

func (x *PathEndpoint) ProtoReflect() protoreflect.Message {
	mi := &file_signalexchange_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PathEndpoint.ProtoReflect.Descriptor instead.
func (*PathEndpoint) Descriptor() ([]byte, []int) {
	return file_signalexchange_proto_rawDescGZIP(), []int{3}
}

func (x *PathEndpoint) GetIp() []byte {
	if x != nil {
		return x.Ip
	}
	return nil
...
func (x *PathEndpoint) GetPort() uint32 {
	if x != nil {
		return x.Port
	}
	return 0
...
func (x *PathEndpoint) GetProbePort() uint32 {
	if x != nil {
		return x.ProbePort
	}
	return 0
...
var file_signalexchange_proto_rawDesc = []byte{
	...
	0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0x98, 0x05, 0x0a, 0x04, 0x42, 0x6f, 0x64, 0x79, 0x12, 0x2d,
	...
	0x72, 0x76, 0x65, 0x72, 0x49, 0x50, 0x88, 0x01, 0x01, 0x12, 0x44, 0x0a, 0x0e, 0x6d, 0x75, 0x6c,
	0x74, 0x69, 0x70, 0x61, 0x74, 0x68, 0x50, 0x61, 0x74, 0x68, 0x73, 0x18, 0x0c, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x1c, 0x2e, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x65, 0x78, 0x63, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x2e, 0x50, 0x61, 0x74, 0x68, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x52,
	0x0e, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x61, 0x74, 0x68, 0x50, 0x61, 0x74, 0x68, 0x73, 0x22,
	0x52, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x09, 0x0a, 0x05, 0x4f, 0x46, 0x46, 0x45, 0x52,
	...
	0x4c, 0x45, 0x10, 0x05, 0x12, 0x0d, 0x0a, 0x09, 0x48, 0x45, 0x41, 0x52, 0x54, 0x42, 0x45, 0x41,
	0x54, 0x10, 0x06, 0x42, 0x15, 0x0a, 0x13, 0x5f, 0x72, 0x65, 0x6c, 0x61, 0x79, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x73,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x42, 0x10, 0x0a, 0x0e, 0x5f, 0x72, 0x65, 0x6c,
	0x61, 0x79, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x49, 0x50, 0x4a, 0x04, 0x08, 0x09, 0x10, 0x0a,
	0x22, 0x50, 0x0a, 0x0c, 0x50, 0x61, 0x74, 0x68, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74,
	...
	,
...
var file_signalexchange_proto_goTypes = []interface{}{
	...
	(*PathEndpoint)(nil),     // 4: signalexchange.PathEndpoint
	(*Mode)(nil),             // 5: signalexchange.Mode
...
var file_signalexchange_proto_depIdxs = []int32{
	...
	5, // 2: signalexchange.Body.mode:type_name -> signalexchange.Mode
	6, // 3: signalexchange.Body.rosenpassConfig:type_name -> signalexchange.RosenpassConfig
	4, // 4: signalexchange.Body.multipathPaths:type_name -> signalexchange.PathEndpoint
