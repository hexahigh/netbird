...
type LoginRequest struct {
	...
	// Multipath spreads a peer connection over extra underlay paths on Linux.
	Multipath               *bool    `protobuf:"varint,44,opt,name=multipath,proto3,oneof" json:"multipath,omitempty"`
	MultipathMode           *string  `protobuf:"bytes,45,opt,name=multipath_mode,json=multipathMode,proto3,oneof" json:"multipath_mode,omitempty"`
	MultipathMaxPaths       *int32   `protobuf:"varint,46,opt,name=multipath_max_paths,json=multipathMaxPaths,proto3,oneof" json:"multipath_max_paths,omitempty"`
	MultipathLocalAddresses []string `protobuf:"bytes,47,rep,name=multipath_local_addresses,json=multipathLocalAddresses,proto3" json:"multipath_local_addresses,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *LoginRequest) GetMultipath() bool {
...
func (x *LoginRequest) GetMultipathMode() string {
	if x != nil && x.MultipathMode != nil {
		return *x.MultipathMode
	}
	return ""
}

func (x *LoginRequest) GetMultipathMaxPaths() int32 {
	if x != nil && x.MultipathMaxPaths != nil {
		return *x.MultipathMaxPaths
	}
	return 0
}

func (x *LoginRequest) GetMultipathLocalAddresses() []string {
	if x != nil {
		return x.MultipathLocalAddresses
	}
	return nil
}
...
type GetConfigResponse struct {
	...
	// Multipath settings.
	Multipath               bool     `protobuf:"varint,30,opt,name=multipath,proto3" json:"multipath,omitempty"`
	MultipathMode           string   `protobuf:"bytes,31,opt,name=multipathMode,proto3" json:"multipathMode,omitempty"`
	MultipathMaxPaths       int32    `protobuf:"varint,32,opt,name=multipathMaxPaths,proto3" json:"multipathMaxPaths,omitempty"`
	MultipathLocalAddresses []string `protobuf:"bytes,33,rep,name=multipathLocalAddresses,proto3" json:"multipathLocalAddresses,omitempty"`
...
func (x *GetConfigResponse) GetMultipath() bool {
	if x != nil {
		return x.Multipath
	}
	return false
...
func (x *GetConfigResponse) GetMultipathMode() string {
	if x != nil {
		return x.MultipathMode
	}
	return ""
...
func (x *GetConfigResponse) GetMultipathMaxPaths() int32 {
	if x != nil {
		return x.MultipathMaxPaths
	}
	return 0
...
func (x *GetConfigResponse) GetMultipathLocalAddresses() []string {
	if x != nil {
		return x.MultipathLocalAddresses
	}
	return nil
...
type PeerState struct {
	...
	// paths lists the extra underlay paths of this peer when multipath is
	// active.
	Paths         []*PathState `protobuf:"bytes,21,rep,name=paths,proto3" json:"paths,omitempty"`
...
func (x *PeerState) GetPaths() []*PathState {
	if x != nil {
		return x.Paths
	}
	return nil
...
// PathState describes one extra underlay path of a peer connection.
type PathState struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// local is the local underlay address:port of the path.
	Local string `protobuf:"bytes,1,opt,name=local,proto3" json:"local,omitempty"`
	// remote is the remote underlay address:port of the path.
	Remote string `protobuf:"bytes,2,opt,name=remote,proto3" json:"remote,omitempty"`
	// iface is the path's WireGuard interface name.
	...
	RxBytes int64  `protobuf:"varint,6,opt,name=rxBytes,proto3" json:"rxBytes,omitempty"`
	// lastHandshake is the unix time of the last WireGuard handshake, zero
	// when no session is established.
	LastHandshake int64   `protobuf:"varint,7,opt,name=lastHandshake,proto3" json:"lastHandshake,omitempty"`
	RttMillis     int64   `protobuf:"varint,8,opt,name=rttMillis,proto3" json:"rttMillis,omitempty"`
	Loss          float64 `protobuf:"fixed64,9,opt,name=loss,proto3" json:"loss,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *PathState) GetLocal() string {
	if x != nil {
		return x.Local
	}
	return ""
...
func (x *PathState) GetRemote() string {
	if x != nil {
		return x.Remote
	}
	return ""
...
func (x *PathState) GetIface() string {
	if x != nil {
		return x.Iface
	}
	return ""
...
func (x *PathState) GetTxBytes() int64 {
	if x != nil {
		return x.TxBytes
	}
	return 0
...
func (x *PathState) GetRxBytes() int64 {
	if x != nil {
		return x.RxBytes
	}
	return 0
...
func (x *PathState) GetLastHandshake() int64 {
	if x != nil {
...
func (x *PathState) GetRttMillis() int64 {
	if x != nil {
		return x.RttMillis
	}
	return 0
...
func (x *PathState) GetLoss() float64 {
	if x != nil {
		return x.Loss
	}
	return 0
...
type SetConfigRequest struct {
	...
	// Multipath spreads a peer connection over extra underlay paths on Linux.
	Multipath               *bool    `protobuf:"varint,39,opt,name=multipath,proto3,oneof" json:"multipath,omitempty"`
	MultipathMode           *string  `protobuf:"bytes,40,opt,name=multipath_mode,json=multipathMode,proto3,oneof" json:"multipath_mode,omitempty"`
	MultipathMaxPaths       *int32   `protobuf:"varint,41,opt,name=multipath_max_paths,json=multipathMaxPaths,proto3,oneof" json:"multipath_max_paths,omitempty"`
	MultipathLocalAddresses []string `protobuf:"bytes,42,rep,name=multipath_local_addresses,json=multipathLocalAddresses,proto3" json:"multipath_local_addresses,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *SetConfigRequest) GetMultipath() bool {
	if x != nil && x.Multipath != nil {
		return *x.Multipath
	}
	return false
...
func (x *SetConfigRequest) GetMultipathMode() string {
	if x != nil && x.MultipathMode != nil {
		return *x.MultipathMode
	}
	return ""
...
func (x *SetConfigRequest) GetMultipathMaxPaths() int32 {
	if x != nil && x.MultipathMaxPaths != nil {
		return *x.MultipathMaxPaths
	}
	return 0
...
func (x *SetConfigRequest) GetMultipathLocalAddresses() []string {
	if x != nil {
		return x.MultipathLocalAddresses
	}
	return nil
...
const file_daemon_proto_rawDesc = "" +
	...
	"\tmultipath\x18, \x01(\bH\x1fR\tmultipath\x88\x01\x01\x12*\n" +
	"\x0emultipath_mode\x18- \x01(\tH R\rmultipathMode\x88\x01\x01\x123\n" +
	"\x13multipath_max_paths\x18. \x01(\x05H!R\x11multipathMaxPaths\x88\x01\x01\x12:\n" +
	"\x19multipath_local_addresses\x18/ \x03(\tR\x17multipathLocalAddressesB\x13\n" +
	...
	"\x12_remoteJobsAllowedB\f\n" +
	"\n" +
	"_multipathB\x11\n" +
	"\x0f_multipath_modeB\x16\n" +
	"\x14_multipath_max_paths\"\xb5\x01\n" +
	"\rLoginResponse\x12$\n" +
	...
	"\busername\x18\x02 \x01(\tR\busername\"\x84\v\n" +
	...
	"\x11remoteJobsAllowed\x18\x1d \x01(\bR\x11remoteJobsAllowed\x12\x1c\n" +
	"\tmultipath\x18\x1e \x01(\bR\tmultipath\x12$\n" +
	"\rmultipathMode\x18\x1f \x01(\tR\rmultipathMode\x12,\n" +
	"\x11multipathMaxPaths\x18  \x01(\x05R\x11multipathMaxPaths\x128\n" +
	"\x17multipathLocalAddresses\x18! \x03(\tR\x17multipathLocalAddresses\x12*\n" +
	"\x10mDMManagedFields\x18\x1c \x03(\tR\x10mDMManagedFields\"\xbb\x06\n" +
	"\tPeerState\x12\x0e\n" +
	...
	"sshHostKey\x12'\n" +
	"\x05paths\x18\x15 \x03(\v2\x11.daemon.PathStateR\x05paths\x12\x12\n" +
	"\x04ipv6\x18\x14 \x01(\tR\x04ipv6\"\xf1\x01\n" +
	"\tPathState\x12\x14\n" +
	"\x05local\x18\x01 \x01(\tR\x05local\x12\x16\n" +
	"\x06remote\x18\x02 \x01(\tR\x06remote\x12\x14\n" +
	"\x05iface\x18\x03 \x01(\tR\x05iface\x12\x14\n" +
	"\x05state\x18\x04 \x01(\tR\x05state\x12\x18\n" +
	"\atxBytes\x18\x05 \x01(\x03R\atxBytes\x12\x18\n" +
	"\arxBytes\x18\x06 \x01(\x03R\arxBytes\x12$\n" +
	"\rlastHandshake\x18\a \x01(\x03R\rlastHandshake\x12\x1c\n" +
	"\trttMillis\x18\b \x01(\x03R\trttMillis\x12\x12\n" +
	"\x04loss\x18\t \x01(\x01R\x04loss\"\x9c\x02\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\"\xfd\x14\n" +
	...
	"\tmultipath\x18' \x01(\bH\x1cR\tmultipath\x88\x01\x01\x12*\n" +
	"\x0emultipath_mode\x18( \x01(\tH\x1dR\rmultipathMode\x88\x01\x01\x123\n" +
	"\x13multipath_max_paths\x18) \x01(\x05H\x1eR\x11multipathMaxPaths\x88\x01\x01\x12:\n" +
	"\x19multipath_local_addresses\x18* \x03(\tR\x17multipathLocalAddressesB\x13\n" +
	"\x11_rosenpassEnabledB\x10\n" +
	"\x0e_interfaceNameB\x10\n" +
	"\x0e_wireguardPortB\x17\n" +
...
var file_daemon_proto_goTypes = []any{
	...
	(*PathState)(nil),                          // 18: daemon.PathState
...
var file_daemon_proto_depIdxs = []int32{
	...
	18,  // 6: daemon.PeerState.paths:type_name -> daemon.PathState
	24,  // 7: daemon.SSHServerState.sessions:type_name -> daemon.SSHSessionInfo
	21,  // 8: daemon.FullStatus.managementState:type_name -> daemon.ManagementState
	20,  // 9: daemon.FullStatus.signalState:type_name -> daemon.SignalState
	19,  // 10: daemon.FullStatus.localPeerState:type_name -> daemon.LocalPeerState
	17,  // 11: daemon.FullStatus.peers:type_name -> daemon.PeerState
	22,  // 12: daemon.FullStatus.relays:type_name -> daemon.RelayState
	23,  // 13: daemon.FullStatus.dns_servers:type_name -> daemon.NSGroupState
	58,  // 14: daemon.FullStatus.events:type_name -> daemon.SystemEvent
	25,  // 15: daemon.FullStatus.sshServerState:type_name -> daemon.SSHServerState
	32,  // 16: daemon.ListNetworksResponse.routes:type_name -> daemon.Network
	112, // 17: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	113, // 18: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	33,  // 19: daemon.ForwardingRule.destinationPort:type_name -> daemon.PortInfo
	33,  // 20: daemon.ForwardingRule.translatedPort:type_name -> daemon.PortInfo
	34,  // 21: daemon.ForwardingRulesResponse.rules:type_name -> daemon.ForwardingRule
	...
	44,  // 24: daemon.ListStatesResponse.states:type_name -> daemon.State
	53,  // 25: daemon.TracePacketRequest.tcp_flags:type_name -> daemon.TCPFlags
	55,  // 26: daemon.TracePacketResponse.stages:type_name -> daemon.TraceStage
	...
	116, // 29: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	114, // 30: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	58,  // 31: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	...
	105, // 36: daemon.ExposeServiceEvent.ready:type_name -> daemon.ExposeServiceReady
	...
	27,  // 47: daemon.DaemonService.ListNetworks:input_type -> daemon.ListNetworksRequest
	29,  // 48: daemon.DaemonService.SelectNetworks:input_type -> daemon.SelectNetworksRequest
	29,  // 49: daemon.DaemonService.DeselectNetworks:input_type -> daemon.SelectNetworksRequest
	4,   // 50: daemon.DaemonService.ForwardingRules:input_type -> daemon.EmptyRequest
	36,  // 51: daemon.DaemonService.DebugBundle:input_type -> daemon.DebugBundleRequest
	38,  // 52: daemon.DaemonService.GetLogLevel:input_type -> daemon.GetLogLevelRequest
	40,  // 53: daemon.DaemonService.SetLogLevel:input_type -> daemon.SetLogLevelRequest
	45,  // 54: daemon.DaemonService.ListStates:input_type -> daemon.ListStatesRequest
	47,  // 55: daemon.DaemonService.CleanState:input_type -> daemon.CleanStateRequest
	49,  // 56: daemon.DaemonService.DeleteState:input_type -> daemon.DeleteStateRequest
	51,  // 57: daemon.DaemonService.SetSyncResponsePersistence:input_type -> daemon.SetSyncResponsePersistenceRequest
	54,  // 58: daemon.DaemonService.TracePacket:input_type -> daemon.TracePacketRequest
	106, // 59: daemon.DaemonService.StartCapture:input_type -> daemon.StartCaptureRequest
	108, // 60: daemon.DaemonService.StartBundleCapture:input_type -> daemon.StartBundleCaptureRequest
	110, // 61: daemon.DaemonService.StopBundleCapture:input_type -> daemon.StopBundleCaptureRequest
	57,  // 62: daemon.DaemonService.SubscribeEvents:input_type -> daemon.SubscribeRequest
	59,  // 63: daemon.DaemonService.GetEvents:input_type -> daemon.GetEventsRequest
	42,  // 64: daemon.DaemonService.RegisterUILog:input_type -> daemon.RegisterUILogRequest
	61,  // 65: daemon.DaemonService.SwitchProfile:input_type -> daemon.SwitchProfileRequest
	63,  // 66: daemon.DaemonService.SetConfig:input_type -> daemon.SetConfigRequest
	65,  // 67: daemon.DaemonService.AddProfile:input_type -> daemon.AddProfileRequest
	67,  // 68: daemon.DaemonService.RenameProfile:input_type -> daemon.RenameProfileRequest
	69,  // 69: daemon.DaemonService.RemoveProfile:input_type -> daemon.RemoveProfileRequest
	71,  // 70: daemon.DaemonService.ListProfiles:input_type -> daemon.ListProfilesRequest
	74,  // 71: daemon.DaemonService.GetActiveProfile:input_type -> daemon.GetActiveProfileRequest
	76,  // 72: daemon.DaemonService.Logout:input_type -> daemon.LogoutRequest
	80,  // 73: daemon.DaemonService.GetFeatures:input_type -> daemon.GetFeaturesRequest
	83,  // 74: daemon.DaemonService.TriggerUpdate:input_type -> daemon.TriggerUpdateRequest
	85,  // 75: daemon.DaemonService.GetPeerSSHHostKey:input_type -> daemon.GetPeerSSHHostKeyRequest
	87,  // 76: daemon.DaemonService.RequestJWTAuth:input_type -> daemon.RequestJWTAuthRequest
	89,  // 77: daemon.DaemonService.WaitJWTToken:input_type -> daemon.WaitJWTTokenRequest
	91,  // 78: daemon.DaemonService.RequestExtendAuthSession:input_type -> daemon.RequestExtendAuthSessionRequest
	93,  // 79: daemon.DaemonService.WaitExtendAuthSession:input_type -> daemon.WaitExtendAuthSessionRequest
	95,  // 80: daemon.DaemonService.DismissSessionWarning:input_type -> daemon.DismissSessionWarningRequest
	97,  // 81: daemon.DaemonService.StartCPUProfile:input_type -> daemon.StartCPUProfileRequest
	99,  // 82: daemon.DaemonService.StopCPUProfile:input_type -> daemon.StopCPUProfileRequest
	101, // 83: daemon.DaemonService.GetInstallerResult:input_type -> daemon.InstallerResultRequest
	103, // 84: daemon.DaemonService.ExposeService:input_type -> daemon.ExposeServiceRequest
	78,  // 85: daemon.DaemonService.WailsUIReady:input_type -> daemon.WailsUIReadyRequest
	...
	28,  // 93: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	30,  // 94: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	30,  // 95: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	35,  // 96: daemon.DaemonService.ForwardingRules:output_type -> daemon.ForwardingRulesResponse
	37,  // 97: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	39,  // 98: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	41,  // 99: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	46,  // 100: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	48,  // 101: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	50,  // 102: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	52,  // 103: daemon.DaemonService.SetSyncResponsePersistence:output_type -> daemon.SetSyncResponsePersistenceResponse
	56,  // 104: daemon.DaemonService.TracePacket:output_type -> daemon.TracePacketResponse
	107, // 105: daemon.DaemonService.StartCapture:output_type -> daemon.CapturePacket
	109, // 106: daemon.DaemonService.StartBundleCapture:output_type -> daemon.StartBundleCaptureResponse
	111, // 107: daemon.DaemonService.StopBundleCapture:output_type -> daemon.StopBundleCaptureResponse
	58,  // 108: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	60,  // 109: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
	43,  // 110: daemon.DaemonService.RegisterUILog:output_type -> daemon.RegisterUILogResponse
	62,  // 111: daemon.DaemonService.SwitchProfile:output_type -> daemon.SwitchProfileResponse
	64,  // 112: daemon.DaemonService.SetConfig:output_type -> daemon.SetConfigResponse
	66,  // 113: daemon.DaemonService.AddProfile:output_type -> daemon.AddProfileResponse
	68,  // 114: daemon.DaemonService.RenameProfile:output_type -> daemon.RenameProfileResponse
	70,  // 115: daemon.DaemonService.RemoveProfile:output_type -> daemon.RemoveProfileResponse
	72,  // 116: daemon.DaemonService.ListProfiles:output_type -> daemon.ListProfilesResponse
	75,  // 117: daemon.DaemonService.GetActiveProfile:output_type -> daemon.GetActiveProfileResponse
	77,  // 118: daemon.DaemonService.Logout:output_type -> daemon.LogoutResponse
	81,  // 119: daemon.DaemonService.GetFeatures:output_type -> daemon.GetFeaturesResponse
	84,  // 120: daemon.DaemonService.TriggerUpdate:output_type -> daemon.TriggerUpdateResponse
	86,  // 121: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	88,  // 122: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	90,  // 123: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	92,  // 124: daemon.DaemonService.RequestExtendAuthSession:output_type -> daemon.RequestExtendAuthSessionResponse
	94,  // 125: daemon.DaemonService.WaitExtendAuthSession:output_type -> daemon.WaitExtendAuthSessionResponse
	96,  // 126: daemon.DaemonService.DismissSessionWarning:output_type -> daemon.DismissSessionWarningResponse
	98,  // 127: daemon.DaemonService.StartCPUProfile:output_type -> daemon.StartCPUProfileResponse
	100, // 128: daemon.DaemonService.StopCPUProfile:output_type -> daemon.StopCPUProfileResponse
	102, // 129: daemon.DaemonService.GetInstallerResult:output_type -> daemon.InstallerResultResponse
	104, // 130: daemon.DaemonService.ExposeService:output_type -> daemon.ExposeServiceEvent
	79,  // 131: daemon.DaemonService.WailsUIReady:output_type -> daemon.WailsUIReadyResponse
